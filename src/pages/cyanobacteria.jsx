...
function Cyanobacteria() {
    return (
      <body>
        ...
        <div className='disc'>Working with a team from the University
                of Colorado&amp;s{' '}
                ...
                intakes csv data and video to sonify Cyanobacteria cells&apos; growth. It
                does so by mapping different heuristics (change in cell size, cell growth
                rate, video movement, etc.) to different properties such as arpeggiator
                rate or the triggering of a kick drum. The output, in MIDI format, is
                currently being used as a soundtrack in the production of a documentary
                about the bacteria. Selections of my work are currently on display at the{' '}
