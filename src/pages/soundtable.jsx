    ...
    return (
      <body>
        <div className='title'>Soundtable</div>
          ...
          it in direct contrast with the digital style popular in the field. The meanings of the controls are
          intentionally obscure on first interaction. This is in an effort to encourage exploration and discovery
          rather than the achievement of specific sonic goals. For those looking to have granular, percise control
          over their synthesis, there is already a variety of technology. Instead, the Soundtable fufills a different
          need: to have a fun, casual introduction to sound synthesis.
          <br /><br />
          Behind the scenes,{' '}
            ...
            <div className='disc'>
              ...
              the needs of the project. This iteration gestured at the grid like asthetic I was intentionally subverting
              while keeping the simplcity needed.
              </div>
            <img className='smallimg' src="https://i.imgur.com/W2rC6hg.jpg" />
            <div className='disc'>
              Once the circutry was working, I wrote a program that recieved serial data from the Arduinos and
              utilized the <a href="https://github.com/ideoforms/pylive" target="_blank" rel="noreferrer">pyLive</a>
            ...
            <br></br>
            <div className='disc'>
              If I were to make another iteration, I woud focus on creating an more organic shape
              to further signal its ideological departure from a tradutional synthesizer/digital music ethos.
            </div>
            </div>
            </div>          
      </body>
