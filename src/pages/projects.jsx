    ...
    return (
        <body>
            ...
            <div className='bricks'>
                ...
                <div className='brickHomepage'>
                    <img className='sampleImg' src='https://media4.giphy.com/media/YUu0xmmRmePOyu8uIh/giphy.gif?cid=790b76114918966cc373c0d38ecd43826ed176ce4cf224d3&rid=giphy.gif&ct=g'></img>
                    <div class="overlay">
            ...
            <div className='bricks'>
                <a href="/iterative">
                <div className='brickHomepage'>
                    <img className='sampleImg' src='https://media3.giphy.com/media/cnagYypJlDdV4b0Uei/giphy.gif?cid=790b76113674abdbe3bcf55322b48ca1826b81c0f38a9fb9&rid=giphy.gif&ct=g'></img>
                    <div class="overlay">
                ...
                <a href="/iterative">
                <div className='brickHomepage'>
                    <img className='sampleImg' src='https://i.imgur.com/8EPBv3q.jpg'></img>
                    <div class="overlay">
                ...
                <a href="/iterative">
                <div className='brickHomepage'>
                    <img className='sampleImg' src='https://i.imgur.com/0xa94m1.jpg?1'></img>
                    <div class="overlay">
                ...
                <a href="/iterative">
                <div className='brickHomepage'>
                    <img className='sampleImg' src='https://i.imgur.com/tOG1dJt.gif'></img>
                    <div class="overlay">
            ...
            <div className='bricks'>
                ...
                <div className='brickHomepage'>
                    <img className='sampleImg' src='https://i.imgur.com/u1J9TG6.jpg'></img>
                    <div class="overlay">
                ...
                <a href="https://woefulworm.github.io/development/">
                <div className='brickHomepage'>
                    <img className='sampleImg' src='https://cdn.vox-cdn.com/thumbor/fvwx9IbRHceEHEWFjYFvRF6S0i0=/41x0:681x480/1400x1400/filters:focal(41x0:681x480):format(jpeg)/cdn.vox-cdn.com/uploads/chorus_image/image/47552007/unnamed-4.0.0.jpg'></img>
                    <div class="overlay">
